 ...
 *
 * @file agentrt_defaults.h
 * @brief AgentRT 全局共享默认值集中定义
 *
 * P0.17 阶段 1：从 daemons/common/include/daemon_defaults.h 迁移至
 * commons/include/agentrt_defaults.h，消除 atoms→daemons 编译期反向依赖
 * （IRON-6: 禁止跨层耦合残留）。宏命名保持 AGENTRT_ 前缀，表明其全局
 * 共享语义，而非 daemon 专属。
 *
...
#ifndef AGENTRT_DEFAULTS_H
#define AGENTRT_DEFAULTS_H
