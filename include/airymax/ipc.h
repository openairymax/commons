...
_Static_assert(offsetof(struct airy_ipc_msg_hdr, crc32) == 52, "crc32 must be at offset 52");
_Static_assert(offsetof(struct airy_ipc_msg_hdr, reserved) == 56, "reserved must be at offset 56");
...
#warning \
    "AIRY_SC_FALLBACK active: ipc.h degraded to minimal 128B header, capability_badge=0 (H6), only SEND/RECV opcodes"
