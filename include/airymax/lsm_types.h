 ...
 */
typedef __s32 (*airy_capability_check_fn)(__u64 badge, __u16 required_perm, __u32 agent_id);
...
#warning \
    "AIRY_SC_FALLBACK active: lsm_types.h degraded to DEFINE_LSM(airy) minimal skeleton, 7 hooks collapse to 3, AIRY_CAP_MAX_AGENTS=64"
