 ...
 * - Implementations live in commons/platform/src/platform_compat.c
 *
 * 0.1.9 0c (IRON-6 归位)：本头文件从 daemons/common/include/ 迁入
 * commons/platform/include（权威版）；daemons/common/include/ 仅保留
 * re-export 兼容头，daemon 源码无需改动包含路径。
 *
 * @see agentrt/commons/platform/include/platform.h        (commons authoritative)
 * @see agentrt/commons/platform/src/platform_compat.c     (platform ext impl)
 */
